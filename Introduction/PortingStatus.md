...
|-----------------|-------------|---------------|
| XiaoMi 9 | cepheus | [Device status](https://github.com/qaz6750/XiaoMi9-Drivers/blob/main/Status.md) |
...
| POCO X3 PRO | vayu | [Device status](https://github.com/WaLoVayu/POCOX3Pro-Windows-Guides/blob/main/en/status.md) |
| XiaoMi Mix 3 | perseus |[Device status](https://github.com/n00b69/woa-perseus/blob/main/guide/status.md) |
| LG G8 | lalphaplus | [Device status](https://github.com/n00b69/woa-alphaplus/blob/main/guide/status.md) |
...
| Device | codename |  Status |
|-----------------|----------------|-------------|
| Xiaomi POCO X3 NFC| miatoll | [Device status](https://github.com/woa-surya/POCOX3NFC-Guides/blob/main/Status-en.md)|
